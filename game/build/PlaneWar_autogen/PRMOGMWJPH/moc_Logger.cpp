...
template <> constexpr inline auto Logger::qt_create_metaobjectdata<qt_meta_tag_ZN6LoggerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'logMessageWritten'
        QtMocHelpers::SignalData<void(const QString &, LogLevel)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->logMessageWritten((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<LogLevel>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Logger::*)(const QString & , LogLevel )>(_a, &Logger::logMessageWritten, 0))
            return;
    }
}
...
// SIGNAL 0
void Logger::logMessageWritten(const QString & _t1, LogLevel _t2)
{
