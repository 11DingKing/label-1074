...
#include "../../../src/ui/GameOverScreen.h"
...
void GameOverScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->menuClicked(); break;
        case 2: _t->onAnimationTick(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameOverScreen::*)()>(_a, &GameOverScreen::restartClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (GameOverScreen::*)()>(_a, &GameOverScreen::menuClicked, 1))
            return;
    }
}
...
// SIGNAL 0
void GameOverScreen::restartClicked()
{
