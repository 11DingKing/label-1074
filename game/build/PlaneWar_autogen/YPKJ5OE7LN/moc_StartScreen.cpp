...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartScreen::*)()>(_a, &StartScreen::startGameClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartScreen::*)()>(_a, &StartScreen::quitGameClicked, 1))
            return;
    }
}
